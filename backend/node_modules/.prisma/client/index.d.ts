...
export namespace Prisma {
  ...
  */
  ...
  export interface Prisma__RecipeClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    user<T extends Recipe$userArgs<ExtArgs> = {}>(args?: Subset<T, Recipe$userArgs<ExtArgs>>): Prisma__UserClient<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow"> | null, null, ExtArgs>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface RecipeFieldRefs {
    ...
    readonly photoUrl: FieldRef<"Recipe", 'String'>
  ...
  export type RecipeWhereInput = {
    ...
    photoUrl?: StringNullableFilter<"Recipe"> | string | null
  ...
  export type RecipeScalarWhereWithAggregatesInput = {
    ...
    photoUrl?: StringNullableWithAggregatesFilter<"Recipe"> | string | null
